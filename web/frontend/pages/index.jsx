...
import { useGetAllStoreCarousels } from "../hooks/carouselHooks.js"
...
const Dashboard = () => {
	...
	const getAllUpsells = useGetAllStoreCarousels()
			...
			{loadingUpsells ? (
				...
				<div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
					<div style={{ width: "850px", paddingBottom: "1rem" }}>
						<h1
							className="neu-text font-satoshi"
							style={{
								marginBottom: "2rem",
								fontStyle: "normal",
								fontWeight: "400",
						...
						>
							👋 Hi there! Welcome to JustUpsell
						</h1>

						<div style={{ display: "flex", gap: "1rem", width: "100%" }}>
							<StatisticCard statName="impressions" title="Impressions" data={{ percentage: 30, number: totalViews }} />
							<StatisticCard statName="addToCart" title="Added to Cart" data={{ percentage: 30, number: totalAddedToCart }} />
							<StatisticCard statName="conversions" title="Conversions" data={{ percentage: 30, number: totalConversions }} />
							<StatisticCard
						...
						<div style={{ marginTop: "3rem", marginBottom: "1.5rem", display: "flex", justifyContent: "space-between" }}>
							<h1 className="neu-text neu-text-600 font-satoshi" style={{ fontSize: "1.5rem" }}>
								Your Upsells
							</h1>
							<div style={{ display: "flex", gap: "1rem" }}>
								...
								<button
									...
									onClick={() => navigate("/newCarouselUpsell")}
								>
									<span className="font-satoshi neu-text neu-text-600" style={{ fontSize: "0.9rem" }}>
										New Upsell
									</span>
								</button>
							</div>
