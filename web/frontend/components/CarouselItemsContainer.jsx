import { SkeletonThumbnail, Thumbnail } from "@shopify/polaris"
...
export const CarouselItemsContainer = (props) => {
	const { loadingUpsellProductImage, shopCurrency } = props
			...
			<div style={{ maxWidth: "100%" }}>
				<Splide options={options} aria-labelledby="autoplay-example-heading" hasTrack={false}>
					<div style={{ position: "relative", marginBottom: "2rem" }}>
						<SplideTrack>
							{variantsInfo.map((item) => (
								<SplideSlide key={`${item.id}carousel`}>
									<div
										style={{
											backgroundColor: "white",
											boxShadow: "0px 5px 5px #dedcdc",
											borderRadius: "1rem",
											display: "flex",
										...
										<div>
											<span
												style={{
													...
													borderRadius: "25px",
													backgroundColor: "white",
													boxShadow: "#ebebeb 0px 2px 5px 2px",
												}}
