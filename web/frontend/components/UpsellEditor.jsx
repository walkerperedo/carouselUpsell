...
import { UpsellPreview } from "../components/UpsellPreview.jsx"
import { UpsellSettings } from "../components/UpsellSettings.jsx"
import { UpsellStyling } from "../components/UpsellStyling.jsx"
import { useCreateUpsell, useUpdateUpsell } from "../hooks/upsellHooks.js"

export const UpsellEditor = ({ upsell, setUpsell, newUpsell }) => {
	...
	return (
		<div style={{ maxWidth: "1200px", margin: "auto" }}>
			...
			<div className="upsell-editor" style={{ marginTop: "1rem", marginBottom: "5rem", display: "flex", gap: "2rem" }}>
				...
				<div className="upsell-editor-settings neu-background neu-shadow neu-border-radius-1" style={{ padding: "1rem 1.5rem 2rem 1.5rem", flex: "1", alignSelf: "flex-start", marginBottom: "50vh" }}>
					...
					{
						selectedTab === 0 ?
							<UpsellSettings upsell={upsell} setUpsell={setUpsell} />
						: selectedTab === 1 ?
							<UpsellStyling upsell={upsell} setUpsell={setUpsell} />
						: ""
					}
				</div>
			</div>
