...
import { UpsellsListPopover } from "./UpsellsListPopover.jsx"
...
export const UpsellsListItem = ({ upsell, index, setUpsells, currency }) => {
	...
	return (
		<div className="neu-background neu-shadow neu-border-radius-1" style={{ width: "100%", display: "flex", alignItems: "center", padding: "1rem" }}>
			...
			<div style={{ width: "15%", display: "flex", gap: "0.5rem" }}>
				<div>
					<Link url={`/upsells/${upsell.id}`} monochrome removeUnderline>
